      ...
      <div className="mx-auto mt-9 max-w-3xl">
        <div className="relative aspect-[4/3] overflow-hidden rounded-[1.75rem] bg-beige-200 shadow-paper sm:rounded-[2.25rem]">
          ...
          <button
            ...
            className="absolute left-3 top-1/2 z-10 flex h-10 w-10 -translate-y-1/2 items-center justify-center rounded-full bg-ivory-50/85 text-olive-800 shadow-paper transition hover:bg-ivory-50 sm:left-4"
          >
          ...
          <button
            ...
            className="absolute right-3 top-1/2 z-10 flex h-10 w-10 -translate-y-1/2 items-center justify-center rounded-full bg-ivory-50/85 text-olive-800 shadow-paper transition hover:bg-ivory-50 sm:right-4"
          >
            <HiChevronRight className="h-6 w-6" />
          </button>
        </div>

        <div className="mt-4 flex snap-x gap-3 overflow-x-auto px-1 pb-2 [scrollbar-width:none] sm:mt-5 sm:justify-center">
