  ...
  return (
    ...
    >
      <motion.div
        ...
        animate={{ opacity: 0.84, scale: [1, 1.012, 1], y: [0, -6, 0], clipPath: "inset(0% 0 0 0)" }}
        transition={{
          opacity: { duration: 1.5, delay: 0.15, ease: EASE },
          clipPath: { duration: 1.6, delay: 0.15, ease: EASE },
          scale: { duration: 18, delay: 1.8, repeat: Infinity, ease: "easeInOut" },
          y: { duration: 18, delay: 1.8, repeat: Infinity, ease: "easeInOut" },
        }}
      >
        <DecorativeImage
      ...
      <motion.div
        className="absolute inset-x-[11%] bottom-[9%] top-[9%] z-[2] overflow-hidden rounded-t-[48%] bg-[#fffaf0]/80"
        initial={{ opacity: 0.9, scaleY: 1 }}
        animate={{ opacity: 0, scaleY: 0.98 }}
        transition={{ duration: 1.15, delay: 1.35, ease: EASE }}
      />
      ...
      <motion.div
        ...
        transition={{
          opacity: { duration: 1.15, delay: 0.65, ease: EASE },
          x: { duration: 1.15, delay: 0.65, ease: EASE },
      ...
      <motion.div
        ...
        animate={{ opacity: 0.95, x: 0, rotate: [0.55, -0.25, 0.55] }}
        transition={{
          opacity: { duration: 1.15, delay: 0.75, ease: EASE },
          x: { duration: 1.15, delay: 0.75, ease: EASE },
      ...
      <motion.div
        ...
        transition={{
          opacity: { duration: 1.05, delay: 0.45, ease: EASE },
          y: { duration: 1.05, delay: 0.45, ease: EASE },
      ...
      <motion.div
        ...
        transition={{
          opacity: { duration: 0.9, delay: 1.55 },
      ...
      <motion.div
        ...
        transition={{
          opacity: { duration: 0.9, delay: 1.7 },
      ...
      <motion.div
        ...
        transition={{
          opacity: { duration: 1.1, delay: 1.05, ease: EASE },
          y: { duration: 8, delay: 2.1, repeat: Infinity, ease: "easeInOut" },
        }}
      >
        <DecorativeImage
